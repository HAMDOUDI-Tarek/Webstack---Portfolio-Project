...
def create_new_window(parent, callback):
    def load_data():
        path = "C:/Users/Expert Info/Desktop/build/ecg.xlsx"
    ...
    def find_folder_by_index(index):
        folder_path = os.path.join("C:/Users/Expert Info/Desktop/build/Database/", index)
    ...
    root.tk.call("source", "C:/Users/Expert Info/Desktop/build/forest-light.tcl")
    root.tk.call("source", "C:/Users/Expert Info/Desktop/build/forest-dark.tcl")
